...
public class SwagPoints extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            Drawable indicatorIcon = ContextCompat.getDrawable(context, R.drawable.indicator);
            ...
            mPoints = a.getInteger(R.styleable.CircularSeekBar_points, mPoints);
            mMin = a.getInteger(R.styleable.CircularSeekBar_min, mMin);
            mMax = a.getInteger(R.styleable.CircularSeekBar_max, mMax);
            mStep = a.getInteger(R.styleable.CircularSeekBar_step, mStep);
            ...
            mTextSize = (int) a.getDimension(R.styleable.CircularSeekBar_textSize, mTextSize);
            textColor = a.getColor(R.styleable.CircularSeekBar_textColor, textColor);
